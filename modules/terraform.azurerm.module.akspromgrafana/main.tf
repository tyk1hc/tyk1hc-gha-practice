resource "azurerm_resource_group_template_deployment" "arm_template_prometheus_dev" { 
count= var.Recording_Rules_enabled ? 1 : 0
...
parameters_content = jsonencode({
    ...
    "clusterResourceId" = {
      value = "/subscriptions/${var.subscriptionId}/resourceGroups/${var.template_cluster_rg_name}/providers/Microsoft.ContainerService/managedClusters/${var.ClusterName}"
    },
    "clusterLocation" = {
      value = "${var.template_location}"
    },
    ...
    "grafanaResourceId"={
      value="/subscriptions/${var.subscriptionId}/resourceGroups/${var.template_rg_name}/providers/Microsoft.Dashboard/grafana/${var.GrafanaName}"
    },
    "grafanaLocation"={
      value="${var.template_location}"
    },
