...
# identity and role assignment for the cluster 
resource "azure_user_assigned_identity" "base" {
  name = "base"
  location = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
}

resource "azure_role_assignment" "base" {
...
resource "azurerm_kubernetes_cluster" "main" {
    ...
    depends_on = [ azure_role_assignment.base ]
}